...
import 'package:photofiy/core/utils/errors/error_code.dart';
import 'package:photofiy/core/utils/errors/exceptions.dart';
...
class Result<T> {
  ...
  B fold<B>(
      B Function(Failure failure) onFailure, B Function(T success) onSuccess) {
...
class NetworkFailure extends Failure {
  ...
  factory NetworkFailure.fromDioError(DioException exception) {
    ...
    if (statusCode == 400 || statusCode == 401 || statusCode == 403) {
      return NetworkFailure(errorMessage.isNotEmpty ? errorMessage : 'Authentication failed');
      ...
      return NetworkFailure(errorMessage.isNotEmpty ? errorMessage : 'Ops There was an Error, Please try again');
    }
  }
}
